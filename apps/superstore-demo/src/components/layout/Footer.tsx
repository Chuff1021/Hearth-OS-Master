...
const footerLinkClass = "text-sm leading-6 text-[#dbe8f7] transition hover:text-[#fde428]";
const footerHeadingClass = "mb-4 text-xs font-black uppercase tracking-[0.22em] text-[#fde428]";
    ...
    <footer className="relative overflow-hidden bg-[#001f3d] text-[#dbe8f7]">
      ...
      <div className="relative border-y border-[#fde428]/20 bg-[#002e5b]/90">
        <div className="mx-auto flex max-w-[1640px] flex-col gap-5 px-4 py-8 md:px-5 lg:flex-row lg:items-center lg:justify-between">
          <div>
            <p className="text-xs font-black uppercase tracking-[0.26em] text-[#fde428]">A Cozy Fireplace</p>
            <h3 className="mt-2 text-2xl font-black tracking-[-0.04em] text-white">Need help before you order?</h3>
            <p className="mt-2 max-w-2xl text-sm leading-6 text-[#dbe8f7]">
          ...
          <div className="flex flex-col gap-3 sm:flex-row">
            <Link href="/contact" className="inline-flex justify-center bg-[#fde428] px-6 py-4 text-sm font-black uppercase tracking-[0.14em] text-black transition hover:bg-[#fff06a]">
              Contact Us
            </Link>
            <Link href="/service-appointment" className="inline-flex justify-center border border-white/20 px-6 py-4 text-sm font-black uppercase tracking-[0.14em] text-white transition hover:border-[#fde428] hover:text-[#fde428]">
              Book Service
            </Link>
          </div>
        </div>
      ...
      <div className="relative mx-auto max-w-[1640px] px-4 py-14 md:px-5">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 xl:grid-cols-[1.15fr_0.8fr_0.9fr_0.85fr]">
          <div className="border border-white/10 bg-white/[0.04] p-6 backdrop-blur">
            ...
            />
            <p className="mt-5 max-w-sm text-sm leading-6 text-[#dbe8f7]">{defaultStoreConfig.tagline}</p>

            <div className="mt-6 space-y-3 text-sm">
              <a href={`tel:${defaultStoreConfig.phone}`} className="flex items-center gap-3 text-white transition hover:text-[#fde428]">
                <Phone className="h-4 w-4 text-[#fde428]" />
                {defaultStoreConfig.phone}
              </a>
              <a href={`mailto:${defaultStoreConfig.email}`} className="flex items-center gap-3 text-white transition hover:text-[#fde428]">
                <Mail className="h-4 w-4 text-[#fde428]" />
                {defaultStoreConfig.email}
              </a>
              <div className="flex items-start gap-3 text-white">
                <MapPin className="mt-0.5 h-4 w-4 text-[#fde428]" />
                <span>
            ...
            <div className="mt-6 flex gap-3">
              {defaultStoreConfig.social.facebook && (
                <a href={defaultStoreConfig.social.facebook} target="_blank" rel="noopener noreferrer" className="border border-white/10 bg-white/[0.06] p-2 text-white transition hover:border-[#fde428] hover:text-[#fde428]" aria-label="Facebook">
                  <Facebook className="h-5 w-5" />
                </a>
              )}
              {defaultStoreConfig.social.instagram && (
                <a href={defaultStoreConfig.social.instagram} target="_blank" rel="noopener noreferrer" className="border border-white/10 bg-white/[0.06] p-2 text-white transition hover:border-[#fde428] hover:text-[#fde428]" aria-label="Instagram">
                  <Instagram className="h-5 w-5" />
                </a>
              )}
              {defaultStoreConfig.social.youtube && (
                <a href={defaultStoreConfig.social.youtube} target="_blank" rel="noopener noreferrer" className="border border-white/10 bg-white/[0.06] p-2 text-white transition hover:border-[#fde428] hover:text-[#fde428]" aria-label="YouTube">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/sale" className="text-sm font-black uppercase tracking-[0.12em] text-[#fde428] transition hover:text-[#fde428]">
                  Sale Items
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm text-[#dbe8f7]">
              <div className="flex items-center gap-3"><Clock className="h-4 w-4 text-[#fde428]" /> Mon-Fri: {defaultStoreConfig.business.hours.weekdays}</div>
              <div className="flex items-center gap-3"><Clock className="h-4 w-4 text-[#fde428]" /> Saturday: {defaultStoreConfig.business.hours.saturday}</div>
              <div className="flex items-center gap-3"><Clock className="h-4 w-4 text-[#fde428]" /> Sunday: {defaultStoreConfig.business.hours.sunday}</div>
            </div>
        ...
        <div className="mt-10 grid gap-4 border-y border-white/10 py-8 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={title} className="border border-white/10 bg-white/[0.04] p-5">
              ...
              <p className="mt-1 text-sm text-[#dbe8f7]">{text}</p>
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-col items-center justify-between gap-4 pt-6 text-sm text-[#b7a795] md:flex-row">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="/privacy" className="transition hover:text-[#fde428]">Privacy Policy</Link>
            <Link href="/terms" className="transition hover:text-[#fde428]">Terms of Service</Link>
            <Link href="/accessibility" className="transition hover:text-[#fde428]">Accessibility</Link>
          </div>
