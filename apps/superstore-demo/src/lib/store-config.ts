...
export const productCategories: ProductCategory[] = [
  ...
  { id: "logs-media", name: "Gas Logs", slug: "logs-media", description: "Gas log sets and hearth media from showroom-supported lines", image: "/depot/Hearth_Classics.jpg" },
...
export const sampleProducts: Product[] = [
  ...
  },
  {
    ...
    images: ["/depot/Hearth_Classics.jpg"],
