...
export const productCategories: ProductCategory[] = [
  {
    ...
    name: "Fireplaces",
    slug: "fireplaces",
    description: "Gas, wood, and electric fireplaces for new construction, remodeling, and room updates",
    image: "/acozy/fireplaces.jpg",
    subcategories: [
      { id: "gas-fireplaces", name: "Gas Fireplaces", slug: "gas-fireplaces", description: "Direct-vent and gas fireplace options", image: "/acozy/fireplaces.jpg" },
      { id: "wood-fireplaces", name: "Wood Fireplaces", slug: "wood-fireplaces", description: "Traditional and efficient wood-burning fireplaces", image: "/acozy/fireplaces.jpg" },
      { id: "electric-fireplaces", name: "Electric Fireplaces", slug: "electric-fireplaces", description: "Electric fireplaces for flexible installs", image: "/acozy/electric-fireplaces.jpg" },
    ],
  },
  {
    id: "inserts",
    ...
    image: "/acozy/gas-wood-stoves.jpg",
    subcategories: [
      { id: "gas-inserts", name: "Gas Inserts", slug: "gas-inserts", description: "Efficient gas fireplace inserts", image: "/acozy/gas-wood-stoves.jpg" },
      { id: "wood-inserts", name: "Wood Inserts", slug: "wood-inserts", description: "High-efficiency wood-burning inserts", image: "/acozy/gas-wood-stoves.jpg" },
      { id: "pellet-inserts", name: "Pellet Inserts", slug: "pellet-inserts", description: "Convenient pellet-burning inserts", image: "/acozy/gas-wood-stoves.jpg" },
  ...
  },
  {
    ...
    name: "Stoves",
    slug: "stoves",
    description: "Freestanding gas and wood stoves for comfortable, efficient heat",
    image: "/acozy/gas-wood-stoves.jpg",
    subcategories: [
      { id: "wood-stoves", name: "Wood Stoves", slug: "wood-stoves", description: "Classic and high-efficiency wood stoves", image: "/acozy/gas-wood-stoves.jpg" },
      { id: "gas-stoves", name: "Gas Stoves", slug: "gas-stoves", description: "Clean-burning gas stoves", image: "/acozy/gas-wood-stoves.jpg" },
    ],
  },
  {
    id: "bbq-grills",
    name: "BBQ Grills",
    slug: "bbq-grills",
    description: "Broilmaster Premium Grills for outdoor cooking and backyard entertaining",
    image: "/acozy/bbq-grills.jpg",
  },
  {
    id: "logs-media",
    name: "Gas Logs",
    slug: "logs-media",
    description: "Gas log sets and burners from Hargrove and Empire Comfort Systems",
    image: "/acozy/gas-logs.jpg",
  },
  {
    id: "doors-screens",
    name: "Glass Doors",
    slug: "doors-screens",
    description: "Fireplace glass doors and screens from Design Specialties and Stoll Industries",
    image: "/acozy/glass-doors.jpg",
  },
  {
    id: "stone-products",
    name: "Stone Products",
    slug: "stone-products",
    description: "Boulder Creek Stone products for fireplace refacing and hearth remodels",
    image: "/acozy/stone-products.jpg",
  },
  {
    id: "accessories",
    name: "Accessories",
...
export const sampleProducts: Product[] = [
  ...
  },
  {
    ...
    brand: "Broilmaster Premium Grills",
    images: ["/acozy/broilmaster-grill.jpg"],
  ...
  },
  {
    id: "cozy-mhp-grill",
    sku: "COZY-MHP-GRILL",
    name: "Modern Flames Electric Fireplace",
    slug: "modern-flames-electric-fireplace",
    description: "Modern Flames electric fireplace options available through A Cozy Fireplace showrooms.",
    shortDescription: "Modern Flames electric fireplaces for flexible room updates.",
    price: 0,
    contactForPricing: true,
  ...
  },
  {
    ...
    name: "SimpliFire Electric Fireplace",
    slug: "simplifire-electric-fireplace",
    description: "SimpliFire electric fireplace options for wall, linear, and room-refresh projects.",
    shortDescription: "Electric fireplace options from SimpliFire.",
    price: 0,
    contactForPricing: true,
    categoryId: "electric-fireplaces",
    brand: "SimpliFire",
  ...
  },
  {
    ...
    description: "Hargrove gas log options available through A Cozy Fireplace.",
  ...
  },
  {
    ...
    brand: "A Cozy Fireplace",
    images: ["/acozy/stone-products.jpg"],
